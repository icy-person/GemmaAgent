...
pub fn tiny_corpus()->String{("Rust is a systems programming language. ".repeat(64))+"A small language model learns to predict the next token. Rust makes the engine fast and explicit. ".repeat(64)}
